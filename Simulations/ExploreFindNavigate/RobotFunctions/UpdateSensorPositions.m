...
s(1).Position(1) = robot.Position(1) + robot.Radius*cos(robot.Heading + s(1).RelativeAngle);
s(1).Position(2) = robot.Position(2) + robot.Radius*sin(robot.Heading + s(1).RelativeAngle);
s(1).AbsoluteAngle = robot.Heading;